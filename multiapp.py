...
class MultiApp:
    ...
    def run(self):
        ...
        st.sidebar.markdown('''
            <a href="https://chs.asu.edu/">
                <img src="https://imgur.com/XSY53jG.png">
            </a>''',
        ...
        st.sidebar.info(
            """
            This website was developed by Rachel Beard at Arizona State University, based on a template using Streamlit development project
